...
export class App {
  ...
  private _dtfluxSelectionService: DTFluxSelectionService =
    new DTFluxSelectionService();
  ...
  constructor() {
    ...
    this._dtfluxURLBuilderService = new DTFluxURLBuilderService(
      this._dtfluxSelectionService,
    );
    this._dtfluxDbService = new DTFluxDbService(); // Replace with your database name
    this._dtfluxExporterService = new DTFluxExporterService();
    this._dtfluxLiveResultService = new DTFluxLiveResultService(
      this._dtfluxURLBuilderService,
    );
    this._dtfluxWebSocketService = new DTFluxWebSocketService(
      this._dtfluxDbService,
      this._dtfluxExporterService,
      this._dtfluxLiveResultService
    );
